...
WuziPlayBoardDesktop::WuziPlayBoardDesktop(QWidget *parent)
{
    setStyleSheet("background: rgb(200, 150, 100)");

    m_chessBoard = new WuZiChessBoardDeskTop;
...
WuziPlayBoardDesktop::~WuziPlayBoardDesktop()
{
}


void WuziPlayBoardDesktop::randomize()
{
...
void WuziPlayBoardDesktop::clearAll()
{
...
void WuziPlayBoardDesktop::cancelLast()
{
...
void WuziPlayBoardDesktop::chessFinished(int winner)
{
    QString outcome;
...
void WuziPlayBoardDesktop::chessUnfinished()
{
    m_labelOutcome->setText(ChineseToUTF8_TSG("比赛结果：未分胜负"));
    m_randomize->setEnabled(true);
}
