#ifndef WUZICHESSBOARDDESKTOP_H
#define WUZICHESSBOARDDESKTOP_H
...
class WuZiChessBoardDeskTop : public QWidget
{
    Q_OBJECT

public:
    explicit WuZiChessBoardDeskTop(QWidget *parent = 0);
    ~WuZiChessBoardDeskTop();
...
public:
    RandomizeThread(WuZiChessBoardDeskTop* board);
    void run();
...
private:
    WuZiChessBoardDeskTop *m_pBoard;
};


#endif // WUZICHESSBOARDDESKTOP_H
